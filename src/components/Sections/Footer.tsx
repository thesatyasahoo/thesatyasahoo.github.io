  ...
  <div className="relative bg-neutral-900 px-4 pb-6 pt-12 sm:px-8 sm:pb-8 sm:pt-14">
    ...
    <div className="flex flex-col items-center gap-y-6">
      ...
      <a
        ...
        <span>
          Provided by <span className="text-white">Satyabrata</span>
          <span className="italic text-yellow">Sahoo</span>
        </span>
      </a>
      <span className="text-sm text-neutral-700">© Copyright {currentYear} Satyabrata Sahoo</span>
    </div>
  </div>
));
